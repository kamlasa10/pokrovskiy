...
Showcase.prototype.onGrabStart = function() {
  document.getElementsByClassName('sliderThree__slide-bg')[0].classList.add('hidden');
...
Showcase.prototype.onGrabEnd = function() {
  document.getElementsByClassName('sliderThree__slide-bg')[0].classList.remove('hidden');
